...
export class AppController {
  ...
  @Get('issue/:id/force-update')
  async forceUpdateIssueInfo(@Param('id') id: number): Promise<string> {
    const data = await this.redmineIssueLoader.forceLoadIssueData(Number(id))
    return JSON.stringify(data)
  }
